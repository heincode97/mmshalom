                    ...
                    <div class="d-lg-block d-flex gap-lg-0 gap-2">
                        ...
                        <div class="d-flex gap-2 mb-2">
                            ...
                            <a href="<?php echo esc_url($facebook); ?>" target="_blank" aria-label="Facebook">
                                <div class="s-icon">
                                    <img src="<?php echo ASSET_URL; ?>images/facebook.svg" class="img-fluid"
                                        alt="Facebook">
                                </div>
                            </a>
                            <?php endif; ?>
                            ...
                            <a href="<?php echo esc_url($twitter); ?>" target="_blank" aria-label="Twitter">
                                <div class="s-icon">
                                    <img src="<?php echo ASSET_URL; ?>images/twitter.svg" class="img-fluid"
                                        alt="Twitter">
                                </div>
                            </a>
                            <?php endif; ?>
                            ...
                            <a href="<?php echo esc_url($linkedin); ?>" target="_blank" aria-label="LinkedIn">
                                <div class="s-icon">
                                    <img src="<?php echo ASSET_URL; ?>images/linked-in.svg" class="img-fluid"
                                        alt="LinkedIn">
                                </div>
                            </a>
                            <?php endif; ?>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo esc_url($instagram); ?>" target="_blank" aria-label="Instagram">
                                <div class="s-icon">
                                    <img src="<?php echo ASSET_URL; ?>images/instagram.svg" class="img-fluid"
                                        alt="Instagram">
                                </div>
                            </a>
                            <?php endif; ?>
                            ...
                            <a href="<?php echo esc_url($youtube); ?>" target="_blank" aria-label="YouTube">
                                <div class="s-icon">
                                    <img src="<?php echo ASSET_URL; ?>images/youtube.svg" class="img-fluid"
                                        alt="YouTube">
                                </div>
                            </a>
                            <?php endif; ?>
                            ...
                            <a href="<?php echo esc_url($trip_adv); ?>" target="_blank" aria-label="TripAdvisor">
                                <div class="s-icon">
                                    <img src="<?php echo ASSET_URL; ?>images/trip-advisor.svg" class="img-fluid"
                                        alt="TripAdvisor">
                                </div>
                            </a>
                            <?php endif; ?>
